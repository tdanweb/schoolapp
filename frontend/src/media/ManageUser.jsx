    ...
    async function approveUser() {
        ...
        try {
            ...
            const approving = await axios.put(api2, {
                user: selection,
                regNo: (JSON.parse(localStorage.getItem("logged-user"))).user
            });
                ...
                >
                    ...
                    <div className="p-5 sm:p-6">
                        ...
                        <div className="flex items-center gap-4 p-4 bg-slate-50 border border-slate-200 rounded-xl">
                            ...
                            <div className="w-14 h-14 shrink-0 rounded-full bg-slate-200 flex items-center justify-center text-slate-500">
                        ...
                        <div className="mt-5 space-y-3">
                            ...
                            <div className="flex justify-between gap-4 border-b border-slate-100 pb-3">
                                ...
                                <span className="px-2.5 py-1 rounded-md bg-blue-100 text-blue-700 text-[10px] font-bold uppercase">
                                    {selectedUser?.thisUser || "N/A"}
                                </span>
                            </div>
                        ...
                        {selectedUser?.approved ? (
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex gap-3 p-4 rounded-xl bg-emerald-50 border border-emerald-200">
                                    ...
                                    <p className="text-xs sm:text-sm text-emerald-800 leading-5">
                                        This account is currently approved and
                                        has access according to its assigned
                                        permissions.
                                    </p>
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-5">
                                    ...
                                    <button
                                        onClick={hideBtn}
                                        className="px-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-600 text-sm font-semibold hover:bg-slate-50 transition"
                                    >
                                        CLOSE
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 rounded-xl bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition"
                                    >
                                        UNAPPROVE
                                    </button>
            ...
            <AnimatePresence>
                ...
                {unapproveConfirm && (
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 bg-slate-950/60 flex items-center justify-center p-4"
                    >
                        ...
                        >
                            ...
                            <h3 className="text-center font-bold text-slate-800 mt-4">
                                Unapprove Account?
                            </h3>

                            <p className="text-center text-sm text-slate-500 mt-2 leading-5">
                                Are you sure you want to remove approval from{" "}
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-6">
                                ...
                                <button
                                    onClick={() => setUnapproveConfirm(false)}
                                    disabled={loading}
                                    className="px-4 py-3 rounded-xl border border-slate-200 text-slate-600 text-sm font-semibold hover:bg-slate-50"
                                >
                                    NO, CLOSE
                                </button>
                                ...
                                <button
                                    onClick={approveUser}
                                    disabled={loading}
                                    className="px-4 py-3 rounded-xl bg-red-600 text-white text-sm font-semibold hover:bg-red-700 flex items-center justify-center gap-2"
                                >
                                    {loading ? (
                                        <>
                                            <span className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />
...
{item.approved ? (
    ...
    <div className="flex items-center gap-2">
        ...
        <button
            onClick={() => setSelection(item.regNo)}
            className="w-8 h-8 rounded-lg bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-800 flex items-center justify-center transition"
            title="Manage user"
        >
            <FaEllipsisV size={13} />
        </button>
...
{item.approved ? (
    ...
    <button
        onClick={() => setSelection(item.regNo)}
        className="shrink-0 w-8 h-8 rounded-full bg-slate-100 text-slate-500 hover:bg-slate-200 flex items-center justify-center transition"
        title="Manage user"
    >
        <FaEllipsisV size={13} />
    </button>
