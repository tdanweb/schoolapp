...
import logo2 from "./real-logo.png"
import portfolioLogo from "./logo-portfolio.png"
import photoCard from "./photo-card.png"
import MyPhoto from "./Dan_Photo.png"

function LogoSmall(){

    return <div className="logo p-2 bg-gry-800 rounded-md shadow-md">
        <img src={logo2} alt="logo" width="40px" height="auto"/>
    </div>
}

function LogoBig(){

    return <div className="logo p-2 bg-gray-800 rounded-md shadow-md">
...
function PortfolioLogo(){
    ...
    return <div className="p-1 bg-white rounded-sm shadow shadow-md">
        <img src={portfolioLogo} alt="logo" width="100px" height="auto"/>
    </div>
}
export {LogoSmall, LogoBig, PortfolioLogo, portfolioLogo, photoCard, MyPhoto}
